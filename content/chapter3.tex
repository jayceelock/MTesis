...
~
  \begin{subfigure}{0.45\textwidth}
     ...
     %\caption{Histogram of the error in the $\phi$ dimension with a mean of 14.7 mili-degrees and a standard deviation of 19.0\degree.}
     \caption{mememememe mememememe mememem ememememem emem e m e m e m e me m e m e m e m em e m e m eme}
  \label{fig:norm-pitch}
  \end{subfigure}
~
  \begin{subfigure}{0.45\textwidth}
     \includegraphics[clip, trim = 150 50 155 0, width=\textwidth]{figures/chapter3/norm_yaw}
     %\caption{Histogram of the error in the $\psi$ dimension with a mean of 0.3 mili-degrees and a standard deviation of 7.99\degree.}
     \caption{memememe memememe mememememe memememe memememememe memememememe memememe`}
  \label{fig:norm-yaw}
  \end{subfigure}
  \caption{meme}
  \label{fig:err-norm}
