...
The graphs in Figure~\ref{fig:err-convergence} show that the error is reduced in the $x$, $z$ and $roll$ dimensions, stays ends unchanged in the $y$ dimension and is worse in the $pitch$ and $yaw$ dimensions.

It was expected that the position dimensions will be improved, since the optimisation weight was placed on reducing their error norm. It is unfortunate, however, that the $y$ dimension's norm did not see improvement. Conversely, the orientation dimensions were not expected to see significant improvement, since no weight was placed on them during optimisation. 
