...
\begin{figure*}
  ...
  \begin{subfigure}{0.48\textwidth}
    ...
    \caption{}
  \end{subfigure}
  \caption[The output of the RBFNNs when used with the training set input.]{Plots of the output of the RBFNNs for the different dimensions when used with the training data set.}
  \label{fig:chap4-rbf-train}
\end{figure*}

Figure~\ref{fig:chap4-rbf-valid} shows the networks' output when tested with the validation data set. Here it can be seen that the RBFNNs' error estimates very closely resemble the true error, with the position network's MSE being smaller in the validation case than for the training case. 
...
\begin{figure*}
  ...
  \begin{subfigure}{0.48\textwidth}
    ...
    \caption{}
  \end{subfigure}
  \caption[The output of the RBFNNs with the validation set input.]{Plots of the output for the RBFNNs when used with the validation data set.}
