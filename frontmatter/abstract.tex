...
Indoor measurement tools cannot be used, since the quadcopters of interest rely on GPS data. Therefore, in this project a computer vision-based (CV) pose measurement system was investigated, designed and implemented to measure the pose of a quadcopter in the outdoors. The system's measurements were compared to a quadcopter's pose estimates, recorded during an outdoor test flight.
